...
function Product( data ) {//TODO не работало как у Дениса, приходится использовать старую версию, надо проверять
   ...
   // this.added = Order.except(data.Price_id);
    ...
    // if ( data.Type_id == 14 ) {
    //     this.defaultCount = 3; // для сета 3 палочки
    // }
    // if ( data.Type_id == 12 || data.Type_id == 13 || data.Type_id == 15 ) {
    //     this.defaultCount = 1; //для ролов суши 1 палочка
    // }
    // if ( !(data.Type_id == 12 || data.Type_id == 13 || data.Type_id == 15 || data.Type_id == 14) ) {
    //     this.defaultCount = 0;
    // }
...
// function Discount( discount_name, discount_percent, conditions ) {
//     var i, ii;
//     this.Price_id = Math.floor( Math.random() * 1000 );
//     if ( typeof discount_name === "object" ) {
//         for ( i in discount_name ) {
//             ii = discount_name[i];
//             this[i] = ii;
//         }
//     } else {
...
//         this.checked = false;
//     }
//     Discount.discountList[this.Price_id] = this
// }
// Discount.prototype.checkConition = function () {
//     if ( this.conditions = null ) {
//         return true;
//     }
//     var i, ii;
//     for ( i in this.conditions ) {
//         ii = this.conditions[i];
//         if ( ii() === true ) {
//             return true;
//         }
//     }
...
//
// var Discounts = {
//     0: { id:0 ,discount_percent: 0, discount_name: "Выберите скидку", conditions: null }
//     , 1: {
//         discount_percent: 10
//         , discount_name: "Навынос"
//         , conditions: [function () {
//             return $( '.delivery_met.active a' ).html() === 'Навынос'
//         }]
//     }
//     , 2: {
//         discount_percent: 15, discount_name: "День рождения", conditions: null
//     }
// };
...
// }
//
// Discount.show = function () {
//     var i, ii, x = $( '#promo_discount' ).empty();
//     for ( i in Discount.discountList ) {
//         ii = Discount.discountList[i];
//         if ( ii.checkConition ) {
//             x.append( '<option' + (ii.checked ? '' : '') + ' value="' + ii.id + '">' + ii.discount_name + '</option>' );
//         }
//     }
// };
//--------------\ скидки |----------------------------------------------------------
