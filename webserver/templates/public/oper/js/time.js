...
function setPeriod(digit) {
    ...
    switch (digit){
        ...
        case "0": time3.setDate(time3.getDate()-1); break;
        case "1": time3.setDate(time3.getDate()-7); break;
        case "2": time3.setMonth(time3.getMonth()-1); break;
        case "3": time3.setFullYear(time3.getFullYear()-1); break;
    }
