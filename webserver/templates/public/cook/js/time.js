...
function timeMinus( a, b, c ) {
    ...
    // console.log(b.indexOf('T')+1);
    // console.log(b.slice(b.indexOf('T')+1,b.indexOf('T')+9));
    // console.log(b.indexOf('T'));
    if ( !a || !b ) return;
